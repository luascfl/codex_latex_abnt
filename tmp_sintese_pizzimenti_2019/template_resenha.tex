...
Essa dinâmica distópica reflete a realidade das aplicações móveis e redes sociais. Os autores lembram que sistemas de ranqueamento não são mera ficção, citando plataformas como Uber e Peeple. É o caso também de aplicativos focados em feedbacks anônimos, como o \textit{Sarahah} (ou plataformas equivalentes que persistem até hoje, a exemplo do \textit{Tellonym} e do \textit{NGL}). O \textit{Sarahah}, que viralizou no Brasil em 2017, foi criado inicialmente para o mundo corporativo como ferramenta de feedback honesto, mas, ao cair no uso do público adolescente, converteu-se rapidamente em um espaço de retaliação e \textit{cyberbullying}.
